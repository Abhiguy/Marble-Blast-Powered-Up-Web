...
export class MbpLevelSelect extends LevelSelect {
	...
	async init() {
		...
		this.menu.setupVaryingButton(this.difficultySelectorCollapsed, [
			'play/difficulty_beginner', 'play/difficulty_intermediate', 'play/difficulty_advanced', 'play/difficulty_expert', 'play/difficulty_custom', 'play/difficulty_sandbox'
		], () => {
		...
		this.createDifficultySection('Gold', './assets/ui_mbp/play/marble_gold.png', [
			...
			{ name: 'Sandbox', arr: MissionLibrary.goldSandbox }
		]);
