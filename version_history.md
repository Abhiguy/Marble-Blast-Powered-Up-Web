...
## 2.6.11
- Added total support for the Custom PowerUp properties! Now any of the inventory powerUps Properties could be modified from a mis file. Checkout the [Mod-Api](https://github.com/Abhiguy/Marble-Blast-Powered-Up-Web/blob/master/modapi.md)

## 2.6.2
- Fixed the incorrect evaluation of tricks in Reverse Timer level. Now the scoring system should be more accurate.

## 2.6.1
- Added the Gravity Criterion logic for specific levels. Good Luck playing those.

## 2.6.0
- Added Total Support for the Custom Jump Ability. This features the Wall Jump, Special jump and Double Jump. Including the Air Dash effect. 
- It could be added by the mis file. For more details, checkout the [Mod-Api](https://github.com/Abhiguy/Marble-Blast-Powered-Up-Web/blob/master/modapi.md)

## 2.5.5
- Fixed the controls once again. Now there wouldn't be clinsky random changing of the camera on touch devices.

## 2.5.4
- Added the sound effects whenever the marble changes the looking direction for the Scary Level.

## 2.5.3
- Fixed the Handling of Multiple Stopwatch Pickups. Now the PowerUp works super.

## 2.5.2
- Fixed the Plane's crashing effect.

## 2.5.1
- Fixed the incorrect respawning on Array of Startpads in Competency Levels.

## 2.5.0
- Added the Competency Level. And yes, with the Array of StartPads!
...
## 2.0.0
- Added the Sandbox levels section including the sandbox levels. Good Luck!
...
## 1.9.1
- Fixed the super Jump Particles issue. Now the Color is close to the original
...
## 1.2.0
- Added a Change in the Hud:
- Now whenever a Time Travel is active, a timer just below the main gameplay clock shows up, displaying how long the time travel lasts.
